  ...
  conversation: {
    ...
    messages: [
        ...
        attachedMedia: [
          {
            ...
            mediaUrl:
              "https://paca-chat-server.s3.eu-west-2.amazonaws.com/800d38f9b61a902c/2f504116-1b3f-4225-5eeb-ee7f641a5c51",
            mimeType: "image/png",
          },
        ],
      ...
      },
      {
        ...
        messageState: 3,
        message:
          "I recently had to integrate passwordless authentication feature with passkeys in a react native project and ran into some issues while building it. I’m writing this articl",
        replyTo: null,
        quotedMessageId: "",
        sharedLocation: {
          lat: 0,
      ...
      },
      {
        ...
        messageState: 3,
        message:
          "You might have to setup code signing in Xcode to run the pre-built IOS app. This is an helpful link : https://github.com/expo/fyi/blob/main/setup-xcode-signing.md",
        replyTo: null,
        quotedMessageId: "",
        sharedLocation: {
          lat: 0,
        ...
        attachedMedia: [
          {
            ...
            mediaUrl:
              "https://paca-chat-server.s3.eu-west-2.amazonaws.com/800d38f9b61a902c/627c1e02-1161-0a8d-5d6d-6c7073f72596",
            mimeType: "audio/mp3",
            uploading: false,
          },
        ],
      ...
      },
      {
        ...
        messageState: 3,
        message:
          "They are going on a walk to get a ride home so we will see if they can you you know",
        replyTo: null,
        quotedMessageId: "",
        sharedLocation: {
          lat: 0,
        ...
        attachedMedia: [
          {
            ...
            mediaUrl:
              "https://paca-chat-server.s3.eu-west-2.amazonaws.com/800d38f9b61a902c/e8d34a8a-876b-4b30-7cf1-5191ee6798ec",
            mimeType: "image/png",
          },
        ],
        attachmentType: "media",
